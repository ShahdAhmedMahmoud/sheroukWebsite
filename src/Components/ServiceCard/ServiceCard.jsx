...
// export default function ServiceCard({ Icon, title, description, index, direction = "bottom" }) {
...
//     <motion.div
//       ref={cardRef}
//       className="group bg-white rounded-2xl shadow-md p-8 cursor-pointer border border-transparent hover:border-[#FFBF00]/30"
...
//     >
//       <div className="w-20 h-20 rounded-full bg-[#F8F9FD] flex items-center justify-center mb-5">
//         <Icon
//           ref={iconRef}
//           strokeWidth={1.3}
...
//       <h3 className="text-xl font-bold text-[#1E2432] mb-2">{title}</h3>
